...
function StepTwo() {
  return (
    ...
    <div className='container step-container'>
        ...
        <div className='item'>
            <h4 className='header'>BUY FELIX WITH ETH</h4>
            <img src={eth} alt='icon'/>
            <p>Once you have sufficient ETH in your wallet (if you do not have ETH or USDT, please select option 1 to purchase ETH first), you can now swap your ETH for FELIX. Type in the amount of FELIX you wish to purchase (1,000 minimum) and then click “Convert ETH”. Your wallet provider will ask you to confirm the transaction and will also show you the cost of gas.</p>
        </div>
